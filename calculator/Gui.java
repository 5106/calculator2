...
public class Gui extends JFrame{
	...
	private JButton one,two,three,four,five,six,seven,eight,nine,zero,decimal,negative,add,subt,div,multiply,equals,reset,delete;
	...
	public Gui() {
		...
		answerfield.setPreferredSize(new Dimension(10, 30));
		la1.setPreferredSize(new Dimension(225, 40));
		la2.setPreferredSize(new Dimension(150, 30));
		la3.setPreferredSize(new Dimension(230, 20));
		la4.setPreferredSize(new Dimension(230, 20));
		la5.setPreferredSize(new Dimension(230, 20));
		la6.setPreferredSize(new Dimension(230, 20));
		la7.setPreferredSize(new Dimension(30, 30));
		la8.setPreferredSize(new Dimension(30, 30));
		la9.setPreferredSize(new Dimension(30, 30));
		la10.setPreferredSize(new Dimension(30, 30));
		...
		add.addActionListener(c); subt.addActionListener(c); div.addActionListener(c); multiply.addActionListener(c);
		equals.addActionListener(c); reset.addActionListener(c);
		...
		contentPanel.add(add); contentPanel.add(subt); contentPanel.add(la4); 
		...
		public void actionPerformed(ActionEvent event) {
			...
			if(src.equals(equals)) {
				...
				if(stemp1 != null && stemp2 !=null) {
					...
					if(operation=='/' && d2 ==0.0) {
						answerfield.setText(" cannot divide by 0");
